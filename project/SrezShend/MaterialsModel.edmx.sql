...
-- --------------------------------------------------
-- Date Created: 12/07/2021 09:37:34
-- Generated from EDMX file: C:\Users\10180027\Source\Repos\alex16541\IT-Software-Solutions-for-Business\project\SrezShend\MaterialsModel.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[Хранилище MaterialModelContainer].[SupplierType]', 'U') IS NOT NULL
    DROP TABLE [Хранилище MaterialModelContainer].[SupplierType];
GO
...
-- Creating primary key on [Id], [Title] in table 'SupplierType'
